...
const projectController = function (Project) {
  ...
  // orginal // const getprojectMembership = async function (req, res) {
  ...
  // REPLACE your old getprojectMembership function with this one.

  // In projectController.js
  // The final, corrected version of getprojectMembership
