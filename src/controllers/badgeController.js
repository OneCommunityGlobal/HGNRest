...
const badgeController = function (Badge) {
  const getAllBadges = async function (req, res) {
    if (!await hasPermission(req.body.requestor.role, 'seeBadges') && !await hasIndividualPermission(req.body.requestor.requestorId, 'seeBadges')) {
      if (!await hasIndividualPermission(req.body.requestor.requestorId, 'getWeeklySummaries') && !await hasIndividualPermission(req.body.requestor.requestorId, 'seeOnlyWeeklySummariesReports')) {
