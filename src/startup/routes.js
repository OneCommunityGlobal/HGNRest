...
const ownerStandardMessageRouter =
  require("../routes/ownerStandardMessageRouter")(ownerStandardMessage);
...
const bmInventoryTypeRouter =
  require("../routes/bmdashboard/bmInventoryTypeRouter")(buildingInventoryType);
