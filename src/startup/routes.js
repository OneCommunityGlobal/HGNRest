...
const bmExpense = require('../models/bmdashboard/buildingExpense');
const {
  invTypeBase,
  materialType,
  consumableType,
...
const bmExpenseRouter = require('../routes/bmdashboard/bmExpenseRouter')(bmExpense);
...
module.exports = function (app) {
  ...
  app.use('/api/bm', bmExpenseRouter);
