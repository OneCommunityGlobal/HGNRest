...
const profileInitialSetupRouter =
  require("../routes/profileInitialSetupRouter")(
    profileInitialSetuptoken,
    userProfile,
    project,
    mapLocations
  );
const permissionChangeLogRouter =
  require("../routes/permissionChangeLogsRouter")(permissionChangeLog);
...
const bmConsumablesRouter =
  require("../routes/bmdashboard/bmConsumablesRouter")(buildingConsumable);
const bmInventoryTypeRouter =
  require("../routes/bmdashboard/bmInventoryTypeRouter")(
    invTypeBase,
    materialType,
    consumableType,
    reusableType,
