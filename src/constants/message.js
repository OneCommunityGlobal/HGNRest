...
export const NEW_USER_BLUE_SQUARE_NOTIFICATION_MESSAGE = `
  ...
  Heads up we’ve removed a <a href=${URL_TO_BLUE_SQUARE_PAGE} style="text-decoration: underline;">“blue square”</a> that 
  ...
  <a href=${URL_TO_BLUE_SQUARE_PAGE} style="text-decoration: underline;"> “Blue Square FAQ”</a>  
  </p>
