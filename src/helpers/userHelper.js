            ...
            if (
              ...
              if (count === 2) {
                await userProfile.updateOne(
                  { _id: personId, "badgeCollection.badge": badgeCollection[j+1].badge._id },
                  {
                    $set: {
                ...
                console.log(`replace badge with ${badge.badgeName}`)
                return;
              }
            }
          }
