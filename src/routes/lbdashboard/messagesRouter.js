...
const lbMessageController = require('../../controllers/lbdashboard/lbMessageController');
const routes = function () {
  ...
  messagesRouter.patch("/messages/mark-as-read", (req, res) => lbMessageController.markMessageAsRead(req, res));
